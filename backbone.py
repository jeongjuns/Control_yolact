...
from W_conv import W_Conv2d1,W_Conv2d2,W_Conv2d3
try:
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, norm_layer=nn.BatchNorm2d, dilation=1, use_dcn=False):
        ...
        self.conv1 = W_Conv2d1(inplanes, planes, kernel_size=1, bias=False, dilation=dilation)
        ...
        if use_dcn:
            ...
            self.conv2 = W_Conv2d2(planes, planes, kernel_size=3, stride=stride,
                                padding=dilation, bias=False, dilation=dilation)

        self.bn2 = norm_layer(planes)
        self.conv3 = W_Conv2d3(planes, planes * 4, kernel_size=1, bias=False, dilation=dilation)
